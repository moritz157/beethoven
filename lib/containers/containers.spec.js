...
describe('container management', () => {
    ...
    it('should throw an "beethoven.json could not be found"-error', () => {
        const ERROR_MSG = 'beethoven.json could not be found';
        expect(() => containers.addContainer('/wrong/path/to/container/')).to.throw('beethoven.json could not be found')
    })
