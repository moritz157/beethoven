...
function inputParams() {
    inquirer.prompt([
        ...
        {
            name: 'start_arguments',
            type: 'text',
            message: 'The arguments passed with the start_command (comma-separated):',
            default: 'app.js'
        },
        {
            name: 'version',
        ...
        if(answers.name && answers.start_command) {
            ...
            else answers.depends = [];
            if(answers.start_arguments) answers.start_arguments = answers.start_arguments.split(',');
            else answers.start_arguments = []
